...
const en = {
  ...
  partner: {
    ...
    plansioItems: ["Marketing & campaigns", "Brand & identity", "Product design"],
    dpTag: "Platform & e-commerce engineering",
    dpItems: ["Web applications & SaaS", "E-commerce platforms", "API integrations"],
...
const bs: Dict = {
  ...
  partner: {
    ...
    plansioItems: ["Marketing i kampanje", "Brend i identitet", "Dizajn proizvoda"],
    dpTag: "Razvoj platformi i e-trgovine",
    dpItems: ["Web aplikacije i SaaS", "E-trgovinske platforme", "API integracije"],
