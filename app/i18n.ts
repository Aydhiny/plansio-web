...
const en = {
  ...
  partner: {
    ...
    h1: "Some projects need",
    hAccent: "two studios.",
    lead: "For clients who need heavyweight platform engineering alongside brand and marketing, we team up with Digital Park — pitching, building and shipping as one combined team.",
    plansioTag: "Brand, marketing & product",
    plansioItems: ["Marketing & campaigns", "Brand & identity", "Product design", "Content & social"],
    dpTag: "Platform & e-commerce engineering",
    dpItems: ["Web applications & SaaS", "E-commerce platforms", "API integrations", "24/7 support & monitoring"],
    processEyebrow: "How it works",
    processH: "One brief, one team, one delivery.",
    process: [
      { step: "01", title: "One brief", body: "You talk to one team. We scope the whole project together, no matter which studio leads which piece." },
      { step: "02", title: "Split by strength", body: "Plansio drives brand, marketing and product. Digital Park drives platform and e-commerce engineering." },
      { step: "03", title: "One delivery", body: "One timeline, one point of contact, one invoice — you never have to referee two agencies." },
    ],
    visit: "Visit Digital Park",
  },
  showcase: {
    hPre: "from the",
    hAccent: "studio.",
  ...
  pricing: {
    ...
    hAccent: "work",
    h2: "together.",
    lead: "Every project is scoped on its own, so the price is too. Tell us what you're building and we'll come back with a number that fits — no templated tiers, no padding.",
    factors: [
      { title: "Scope", body: "A single deliverable or a full-stack build — priced for what's actually in it, not a package it has to fit into." },
      { title: "Timeline", body: "A tight deadline costs differently than a relaxed roadmap. We're upfront about that trade-off before you commit to anything." },
      { title: "Team", body: "One discipline or all three — marketing, design and software — staffed to match what the project actually needs." },
    ],
    ctaLabel: "Get a quote",
    ctaNote: "A free scoping call — no obligation, no generic invoice.",
  },
  cta: {
...
const bs: Dict = {
  ...
  partner: {
    eyebrow: "Studijsko partnerstvo",
    h1: "Neki projekti traže",
    hAccent: "dva studija.",
    lead: "Za klijente kojima je uz brend i marketing potreban i ozbiljan razvoj platformi, udružujemo se s Digital Parkom — zajedno pitchujemo, gradimo i isporučujemo kao jedan tim.",
    plansioTag: "Brend, marketing i proizvod",
    plansioItems: ["Marketing i kampanje", "Brend i identitet", "Dizajn proizvoda", "Sadržaj i društvene mreže"],
    dpTag: "Razvoj platformi i e-trgovine",
    dpItems: ["Web aplikacije i SaaS", "E-trgovinske platforme", "API integracije", "Podrška i nadzor 24/7"],
    processEyebrow: "Kako to izgleda",
    processH: "Jedan brief, jedan tim, jedna isporuka.",
    process: [
      { step: "01", title: "Jedan brief", body: "Razgovaraš s jednim timom. Projekat zajedno skopiramo, bez obzira koji studio vodi koji dio." },
      { step: "02", title: "Podjela po snazi", body: "Plansio vodi brend, marketing i proizvod. Digital Park vodi platformu i razvoj e-trgovine." },
      { step: "03", title: "Jedna isporuka", body: "Jedan rok, jedna kontakt osoba, jedna faktura — nikad ne moraš posredovati između dvije agencije." },
    ],
    visit: "Posjeti Digital Park",
  },
  showcase: {
    hPre: "iz",
    hAccent: "studija.",
  ...
  pricing: {
    ...
    hAccent: "radimo",
    h2: "zajedno.",
    lead: "Svaki projekt se posebno skopira, pa je tako i cijena. Reci nam šta gradiš i javljamo se s brojkom koja odgovara — bez gotovih paketa, bez naduvavanja.",
    factors: [
      { title: "Obim", body: "Jedan deliverable ili full-stack izrada — cijena prati ono što je stvarno u projektu, ne paket u koji mora stati." },
      { title: "Rok", body: "Kratak rok košta drugačije od opuštenog plana. Iskreni smo oko tog kompromisa prije nego što se na bilo šta obavežeš." },
      { title: "Tim", body: "Jedna disciplina ili sve tri — marketing, dizajn i softver — po mjeri onoga što projekt zaista traži." },
    ],
    ctaLabel: "Zatraži ponudu",
    ctaNote: "Besplatan poziv za procjenu obima — bez obaveze, bez generičke fakture.",
  },
  cta: {
