...
const FAQ: Record<"en" | "bs", { q: string; a: string }[]> = {
  en: [
    ...
    { q: "What are your pricing tiers?", a: "Spark (500 KM/project) for a single focused deliverable, Studio (1300 KM/month) for a dedicated team on retainer, and Scale (4500 KM) for full-stack product & brand partnerships." },
  ...
  bs: [
    ...
    { q: "Kakvi su vaši cjenovni paketi?", a: "Spark (500 KM/projekat) za jedan fokusiran deliverable, Studio (1300 KM/mjesec) za posvećen tim na retaineru, i Scale (4500 KM) za full-stack partnerstvo za proizvod i brend." },
