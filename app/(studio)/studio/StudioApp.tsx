...
type Tab = "theme" | "brand" | "products" | "projects" | "blog";
...
export default function StudioApp({
  ...
  const save = async () => {
    ...
    const res = await fetch("/api/studio/save", {
      ...
      body: JSON.stringify({ settings, products, projects, posts }),
    });
    setSaving(false);
    if (res.ok) {
      setSaved(true);
  ...
  return (
    <div className="st-app">
      ...
      <main className="st-main">
        ...
        {tab === "projects" && <ProjectsPanel value={projects} onChange={onProjects} />}
