...
/*
 * Prismatic Burst (React Bits) on ogl. Adapted to TS + perf-guarded for this
 * project: DPR capped to 1 and the render throttled to ~30fps (the two biggest
 * levers on a 44-step raymarch), plus it already pauses when off-screen/hidden.
 */
